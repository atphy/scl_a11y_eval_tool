  ...
  render() {
    return(
      <ul className="nav nav-tabs card-header-tabs" role="tablist">
        ...
        <li className="nav-item">
          <a className={this.state.active === 'aria' ? "nav-link active" : "nav-link"} aria-selected={this.state.active === 'aria' ? "true" : "false"} role="tab" aria-controls="html 5" href="/aria" onClick={(e) => this.handleClick(e, 'aria')}>HTML 5 + Aria</a>
        </li>
        <li className="nav-item">
